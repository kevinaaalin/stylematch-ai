...
import { Check, Coins, Crown, ImagePlus, Layers3, Loader2, Upload, Wand2 } from "lucide-react";
...
export default function ReferenceCanvas() {
  ...
  const generateRevision = async () => {
    ...
    } catch { setError("AI 修改版本產生失敗，請稍後再試。"); }
