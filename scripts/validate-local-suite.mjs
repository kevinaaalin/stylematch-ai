...
const suites = {
  core: ['runtime-identity', 'deployment-config', 'style-catalog', 'style-analysis', 'image-style-fallback', 'style-test-images', 'style-test-scoring', 'unified-image-tasks', 'tigi-knowledge-index', 'knowledge-chunks'],
