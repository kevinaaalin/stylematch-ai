...
const suites = {
  ...
  workflow: ['project-floor-plans', 'workflow-revisions', 'asset-compatibility', 'revision-lineage', 'image-result-transaction', 'generated-image', 'proposal-versions', 'budget-scenario', 'image-task-ownership', 'proposal-context'],
